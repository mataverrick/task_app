...
-- AddForeignKey
ALTER TABLE "Tareas" ADD CONSTRAINT "Tareas_tarea_usuario_id_fkey" FOREIGN KEY ("tarea_usuario_id") REFERENCES "Usuarios"("usuario_id") ON DELETE RESTRICT ON UPDATE CASCADE;
